...
<div id="modal"></div>
    <div class="categoryBox">
		<form method="POST" action="">
            <center>
            <img src="img/category/drinksIcon.png" style="opacity: 0.4; margin-top:10px; width: 64px;">
            <p style="font-family: sitkaSmall;">Bebidas</p>
            ...
            ?>
                    <tr style="color:white;">
                        <td><img class="usersImg" style="width:32px; height:auto;" src="img/category/drinksIconCircle.png"></td>
                        <td><?php echo $name;?></td>
