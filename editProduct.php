...
<div id="modal"></div>
    <div class="productBox">
		<form method="POST" action="updateProduct.php?id=<?php echo $id;?>">
            ...
            <p><input type="text" name="UnitsInStock" value="<?php echo $res['UnitsInStock'];?>" placeholder="Unidades em Stock" class="in"></p>
            <p><input type="text" name="UnitPrice" value="<?php echo $res['UnitPrice'];?>€" placeholder="Preço Unitário" class="in"></p>
